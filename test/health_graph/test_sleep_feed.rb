  ...
  context 'sleep' do
    setup do
      ...
      stub_request(:get, HealthGraph.endpoint + '/sleep'
        ).with(headers: { 'Authorization' => 'Bearer ' + TEST_USER_TOKEN, 'Accept' => HealthGraph.accept_headers[:sleep_feed] }
    ...
    should 'make request to api' do
      ...
      assert_requested :get,  HealthGraph.endpoint + '/sleep', headers: { 'Authorization' => 'Bearer ' + TEST_USER_TOKEN, 'Accept' => HealthGraph.accept_headers[:sleep_feed] }, times: 1
    end
